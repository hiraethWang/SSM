...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12" style="text-align: center;margin-top:20px">
            ...
            <button onclick="sendMsg();" class="btn btn-success" style="width:1024px;margin:0 auto;">发送</button>
...
<script type="text/javascript">
    ...
    websocket.onerror = function () {
        setMessageInnerHTML("<li>error</li>");
    };
    ...
    function setMessageInnerHTML(innerHTML) {
        $("#msg").append("<li>"+innerHTML+"</li>");
      var scrollTopBottom;
    	scrollTopBottom=$("#msg").scrollTop()+300;
    	 $("#msg").animate({scrollTop:scrollTopBottom},"slow");
    };
